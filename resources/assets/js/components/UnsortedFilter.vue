       ...
       <div class="container "> 
        ...
        <div class="careerfy-search-filter-wrap careerfy-search-filter-toggle">
                                        ...
                                        <div class="careerfy-checkbox-toggle croll_div" id="career_level_unsorted">
                                            <ul class="careerfy-checkbox"> 
                                                <li>
                                 <input type="checkbox" id="jcid_unsorted" name="career_level[]" value="jcid_unsorted" />
                                                    <label for="jcid_unsorted"><span></span>name</label>
                                                    <small>4</small>
                                                </li> 
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="careerfy-search-filter-wrap careerfy-search-filter-toggle">
                               ...
                               <div id="qualify_unsorted">
                                            ...
                                            <ul class="careerfy-checkbox">
                                        <li>
                                         <input type="checkbox" id="qu_id" name="qu[]" value="id" />
                                                    <label for="qu_id"><span></span>name</label>
                                                </li>
...
props: ['job_id'],
  ...
  methods:{
    ...
    fetchApplicantsByJobID(page_url) {
      let vm = this;
    page_url = page_url || "/api/job/applicants/" + this.job_id
