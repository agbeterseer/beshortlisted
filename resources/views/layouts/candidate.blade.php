...
<!--[if !IE]><!-->
    ...
    <head>
        <meta charset="utf-8" />
        <title> Rhizome Consulting | Verification Slip</title>
    ...
    <li>
          <a href="{{ url('user/profile')}}"><i class="icon-user"></i> My Profile
             ...
             <div class="page-sidebar-wrapper">
                      ...
                      <div class="page-sidebar navbar-collapse collapse">
                          ...
                          <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                              ...
                              <a href="javascript:window.print()" class="nav-link nav-toggle">
                ...
                <div class="page-content-wrapper">
                 ...
                 <!--               <div class="page-title">
                            <h1>Leave Management
                                <small>Create, Modify, Views.. etc.</small>
                            </h1>
                        </div> -->
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2018 &copy; Rhizome Consulting
                </div>
