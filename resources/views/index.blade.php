                       ...
                       <h2>Featured Jobs Listings</h2>
                        ...
                        <div class="col-md-12 careerfy-typo-wrap">
                          ...
                          <div class="space">&nbsp;</div>
                            ...
                            <div class="careerfy-plain-btn"> <a href="{{route('list.job')}}">View All Jobs</a> </div>
                        </div>
          ...
          <div class="col-md-12 careerfy-typo-wrap">
                 <div class="space">&nbsp;</div>
                  <div class="space">&nbsp;</div>
                            ...
                            <div class="categories-list"> 
                                ...
                                @foreach($industries_paginage as $industry)
                                    <li class="careerfy-column-3">
                                        ...
                                        <span> @foreach($job_function_count as $function_count) @if($function_count->job_category === $industry->id) {{ $function_count->total}}  @endif @endforeach Open Vacancies </span>
                                    </li>
                                    @endforeach
                    ...
                    <div class="space">&nbsp;</div>
            <!-- Main Section -->
<div class="jobsearch-main-section careerfy-element-list-full">
                ...
                <div class="container">
                    ...
                    <section class="careerfy-element-text" align="center">
                        ...
                        <div class="space">&nbsp;</div>
                        <div class="space">&nbsp;</div>
                        <div class="careerfy-element-text col-md-3">
                            <h2>Just 3 steps</h2>
