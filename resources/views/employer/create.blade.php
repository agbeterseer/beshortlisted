...
@section('content')
    <!-- Main Section -->
                 ...
                 <form class="careerfy-employer-dasboard" id="frm" method="POST" action="{{route('employer.store')}}"  enctype="multipart/form-data">
                                        {{ csrf_field() }}
                 ...
                 <input value="{{$client->name}}"  onblur="if(this.value == '') { this.value ='raveholdings'; }" onfocus="if(this.value =='raveholdings') { this.value = ''; }" type="text" maxlength="50" name="name" required="required">
                                            ...
                                            <li class="careerfy-column-6">
                                                <label>Email *</label>
    <input class="form-control" value="" onblur="if(this.value == '') { this.rvalue ='employer@localhost.com'; }" onfocus="if(this.value =='employer@localhost.com') { this.value = ''; }" type="email"  id="email" maxlength="20" required="required" name="email">
                                            </li>
                                            <li class="careerfy-column-6">
                                                <label>Phone *</label>
     
  <input class="form-control" name="phone_number" type="text" maxlength="11" placeholder="(XXX) XXX-XXXX" onkeypress="return isNumber(event)"  required="required" />
                                            </li>
                                            <li class="careerfy-column-6">
                                                <label>Website</label>
                                 <input value="http://rhizomeng.com" onblur="if(this.value == '') { this.value ='http://rhizomeng.com'; }" onfocus="if(this.value =='http://rhizomeng.com') { this.value = ''; }" type="text" name="website" maxlength="100">
                                            </li>
                                            <li class="careerfy-column-6">
                           ...
                           <input value="10/10/2008" onblur="if(this.value == '') { this.value ='10/10/2008'; }" onfocus="if(this.value =='10/10/2008') { this.value = ''; }" type="date" name="founded_date">
                                            </li>
                                            <li class="careerfy-column-12">
                                                <label>Description *</label>
                                                <textarea class="form-control" name="description" id="description" required="required" placeholder=""></textarea>
                                            </li>
                                        </ul>
                                    </div>
                            <div class="careerfy-employer-box-section">
                                            ...
                                            <ul class="careerfy-row careerfy-employer-profile-form">
                                                ...
                                                <input placeholder="Enter Full Address" required="required" type="text" name="full_address" maxlength="250" >
                                                </li>  
                                            </ul>
                                        </div>
                                    <div class="careerfy-employer-box-section">
