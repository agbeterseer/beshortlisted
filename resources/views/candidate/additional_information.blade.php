 ...
 <div class="portlet light bordered">
                ...
                <div class="portlet-title table_header">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold ">Career Objective and/or Summary</span>
                    </div>                
                </div>


 
<form class="form-horizontal" action="{{ route('update.career_summary') }}" method="post" role="form">
{{ csrf_field() }}
<!-- <form role="form"> -->
<div class="row">
<div class="col-md-12">
