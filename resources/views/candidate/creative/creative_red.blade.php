...
<body>
    ...
    <table class="center2"><tr><td width="50%" align="right">  
    ...
    <img src="{{asset('/img/terseer.jpg')}}" class="img-circle" alt="Picture" height="180px;" width="150px;"> 
      ...
      <span class="resume_profession" >Software Developer </span><br></div>
       </td><td align="right" width="50%"><img src="{{asset('/img/creativered-new.fw.jpg')}}"  width="320px;" height="266"   alt="Picture" > </td></tr></table>
                          </td></tr></table> 
  <!--                              
...
<table width="100%" align="left" border="0" height="20%"> <tr>
<td  class="leftpad" >
EXPERIENCE  
</td></tr></table>
<div class="space">&nbsp;</div> 
