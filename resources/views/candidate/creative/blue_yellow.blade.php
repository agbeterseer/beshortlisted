...
<!--    <link href="{{ asset('recruit/css/bootstrap.css')}}" rel="stylesheet">
    ...
    <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries # fc4b37 #0990f7 -->
 ...
 #halfCircle {
   ...
   #triangle-topright {
    ...
    #triangle-bottomleft {
      width:100%;
      height: 65;
      border-bottom: 100px solid #13b5ea;
...
<body>
  ...
  <div id="infoi">
    ...
    <img src="{{asset('/img/terseer.jpg')}}"  class="img-circle" alt="Picture" height="180px;" width="150px;"> 
        <span class="uppercase resume_name"> Agbe Terseer Terseer</span> 
        <span class="resume_profession">Software Developer </span>
    </div>

    <div class="space"> &nbsp;</div> 
    <div id="triangle-topright"></div>
    <div id="infori" class="col-md-4">
      <span class=""> <h4>  <strong >  CONTACT </strong>.</h4>
...
<div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 50%; background-color: {{$font_color}};" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Cloud hosting(<span class="number visits" data-counter="counterup" data-value="75">50%</span>)</div>
</div>

<div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 75%; background-color: {{$font_color}};" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
Springboot<span class="number visits" data-counter="counterup" data-value="75"></span>%</div>
</div>
<div class="progress">
  <div class="progress-bar" role="progressbar" style="width: 0%; background-color: {{$font_color}};" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" id="hey" >
Hibernate<span class="number visits" data-counter="counterup" data-value="100"></span>% </div>
  <span style="color: #000000;">(0%)</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="easy-pie-chart">
                                                    <div class="number visits" data-percent="0">
                                                       <!--  <span>+85</span>% -->
                                    <span class="number visits" data-counter="counterup" data-value="0"></span>%</div>
...
<div class="space">&nbsp;</div> 
 <div id="textbox">
  <span class="alignleft"><strong>Panet Technologies.
  </strong></span>
  <span class="alignright year" >2009-2014.</span><br>
</div>
...
<span class="space">&nbsp;</span> 
<div id="textbox">
  <span class="alignleft"><strong>University Of Agriculture Makurdi</strong></span>
  <span class="alignright year">2009-2014.</span><br>
</div>
<div style="clear: both;"></div>
<strong>Mathematics / Computer Sci</strong>
</div></div></div>
