...
<body>
  ...
  <div> <h4> <strong style="vertical-align: middle;">  <i class="fa fa-briefcase " aria-hidden="true" ></i> EXPERIENCE</strong>.</h4></div>
<hr> 
...
<div class="space">&nbsp;</div>
<div><h4> <strong style="vertical-align: middle;"><i class="fa fa-graduation-cap img-circle" style="background-color: #cccccc;" aria-hidden="true"></i> EDUCATION</strong>.</h4></div>
                                            <hr>
<ul>
  <li>  <div id="textbox">
