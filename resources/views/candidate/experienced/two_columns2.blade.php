...
<!-- 
                   <table class="resume_title"> 
                                <tr>
                                <td width="20%" class="t_label" valign="top"> </td> <td width="80%" valign="bottom" align="left"> /td>
                                </tr></table> 

 <br> -->

                          <div align="left">
                          <strong> <span style="font-size: 25px; padding-right: 10px;" class="uppercase">Terseer Agbe </span></strong><br>
...
<!-- <div class="space">&nbsp;</div>  -->
 ...
 <!-- <div class="space">&nbsp;</div> -->
                           <table> 
                          <tr>
                          <td width="20%" valign="top">EXPERIENCE </td> <td width="80%">Panet Technologies 2009-2014<br>Mathematics / Computer Sci<br>  <span class="space">&nbsp;</span> Sotfware Developer 
...
<br></span>
                            ...
                            <table> 
                            <tr>
                            <td width="20%">EDUCATIONAL QUALIFICATION </td> <td width="80%">University Of Agriculture Makurdi<br>Mathematics / Computer Sci<br>2009-2014. </td>
                            </tr></table>  
...
<!-- <div class="space">&nbsp;</div> -->
 ...
 <!-- <span class="space">&nbsp;</span> --> 
               <table> <tr>
               <td width="20%">AREA OF INTEREST </td>
               <td>velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget </td>
               </tr></table>  
                 <table><tr>
                  <td width="20%">TRAINING ATTENDED</td> <td>velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget</td></tr></table> 
       
                  <table > <tr>
                    <td width="20%">WORKSHOP ATTENDED </td><td>velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget</td></tr></table>
                </div>
            </div>
