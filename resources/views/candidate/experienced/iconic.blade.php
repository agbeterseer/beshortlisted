...
<body>
    ...
    <div class="col-md-8">
            ...
            <div class="portlet light bordered">
                ...
                <div class="space">&nbsp;</div>
                                        ...
                                        <div align="center"><h4> <strong style="vertical-align: middle;">CAREER OBJECTIVES</strong>.</h4></div>
                                            <hr>
    ...
    <div class="space">&nbsp;</div>
<div> <h4> <strong style="vertical-align: middle;">  <i class="fa fa-briefcase fa " aria-hidden="true" ></i> EXPERIENCE</strong>.</h4></div>
<hr> 
...
<br></span>
                                              ...
                                              <div class="space">&nbsp;</div>
         <div ><h4> <strong style="vertical-align: middle;"><i class="fa fa-graduation-cap img-circle" style="background-color: #cccccc;" aria-hidden="true" ></i> Educational Qualification</strong>.</h4></div>
                                            <hr>
<div id="textbox">
...
Mathematics / Computer Sci
                             ...
                             <div class="space">&nbsp;</div>
<h4> <strong style="vertical-align: middle;"> <i class="fa fa-book img-circle" aria-hidden="true" ></i> Area of Interest</strong>.</h4>
<hr>  
                                 <span style="margin-top: 20px;"> velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget
                                 </span>
                                 <div class="space">&nbsp;</div>

<h4> <strong style="vertical-align: middle;"> <i class="fa fa-gear img-circle" aria-hidden="true" ></i> Training of Interest</strong>.</h4>
<hr>
                
                                        velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget
                                        <div class="space">&nbsp;</div>
<h4> <strong style="vertical-align: middle;"> <i class="fa fa-wrench img-circle" aria-hidden="true" ></i> Workshop Attended</strong></h4>
<hr>                                     
                                        <br>
                                        velit non tincidunt. Donec pretium gravida erat, a faucibus velit egestas eget
