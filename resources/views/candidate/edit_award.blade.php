...
<div class="title">
<div class="actions">
<p class="editov2"><a class="delete" href="{{route('delete.award', $award->id)}}">Delete</a></p>
</div>
...
{{ csrf_field() }}
<input type="hidden" name="award" value="{{$award->id}}" hidden="hidden"> 
      <div class="form-group{{ $errors->has('certification_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="certification_name" type="text" class="form-control" name="certification_name" value="{{ $award->name }}" required autofocus>
