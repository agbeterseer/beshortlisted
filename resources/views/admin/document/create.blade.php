...
@section('content')
    ...
    <div class="col-md-12">
            ...
            <div class="portlet light bordered">
             ...
             <form class="form-horizontal" action="{{route('document.store')}}" enctype="multipart/form-data" method="post" role="form">
                        {{ csrf_field() }}
            <div class="form-group{{ $errors->has('candidates_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
         <input id="" type="text" class="form-control" name="candidates_name" placeholder="Enter name of candidates name"   required>
           ...
           <div class="form-group{{ $errors->has('profession') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6 "> 
                         <select  name="profession[]" multiple class="form-control select2" required="required" >
            ...
            <div class="form-group{{ $errors->has('years_of_experience') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input id="" type="number" class="form-control" placeholder="Enter years Of Experience" name="years_of_experience" required>
