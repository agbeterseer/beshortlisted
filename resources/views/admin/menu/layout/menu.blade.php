...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title> Rhizome HRMS| Admin Dashboard </title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Admin page for statistics, charts, recent events and reports" name="description" />
          <!-- CSRF Token -->
   ...
   <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
        ...
        <link href="{{asset('css/assets/global/plugins/ladda/ladda-themeless.min.css') }}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ asset('css/assets/layouts/layout4/css/layout.min.css') }}" rel="stylesheet">
        <link href="{{ asset('css/assets/layouts/layout4/css/themes/default.min.css') }}" rel="stylesheet">
        <link href="{{ asset('css/assets/layouts/layout4/css/custom.min.css') }}" rel="stylesheet">
 ...
 @include('admin.menu.layout.includes.sidenav')
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>Admin Dashboard
                                ...
                                <small>Users, roles, recent events and reports</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                 ...
                 <!--            <div id="dashboard-report-range" data-display-range="0" class="pull-right tooltips btn btn-fit-height green" data-placement="left" data-original-title="Change dashboard date range">
                           ...
                           <!--  <div class="btn-group btn-theme-panel">
                            ...
                            <!-- END THEME PANEL -->
                         <small> <font color="red">(beta)</font>  </small>   <a href="javascript: history.go(-1)"><< previous</a> 
                        </div>
                        <!-- END PAGE TOOLBAR -->
                    </div>
                    <!-- END PAGE HEAD-->
    ...
    <home>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2018 &copy; 
                <a target="_blank" href="">Rhizome Consulting</a> &nbsp;|&nbsp;
                <a href="{{url('/admin_user_mannual')}}" title="admin manual " target="_blank">Help</a>
            </div>
...
<![endif]-->
	...
	<script src="{{ asset('js/main.js') }}" type="text/javascript"></script>
      ...
      <script src="{{ asset('css/assets/global/plugins/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
       ...
       <script src="{{ asset('css/assets/global/plugins/jquery.blockui.min.js') }}" type="text/javascript"></script> 
        ...
        <!-- <script src="{{ asset('css/assets/global/plugins/amcharts/amcharts/amcharts.js') }}" type="text/javascript"></script>  -->
        ...
        <script src="{{ asset('css/assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js')}}" type="text/javascript"></script>
    
        <script src="{{ asset('css/assets/global/plugins/horizontal-timeline/horizontal-timeline.js') }}" type="text/javascript"></script>
        <script src="{{ asset('css/assets/global/plugins/flot/jquery.flot.min.js') }}" type="text/javascript"></script>
         <script src="{{ asset('css/assets/global/plugins/flot/jquery.flot.resize.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('css/assets/global/plugins/flot/jquery.flot.categories.min.js') }}" type="text/javascript"></script>
   ...
   <script src="{{asset('css/assets/pages/scripts/form-wizard.min.js')}}" type="text/javascript"></script>
           <script src="{{asset('css/assets/global/plugins/ladda/spin.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('css/assets/global/plugins/ladda/ladda.min.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('css/assets/global/plugins/jquery-repeater/jquery.repeater.js')}}" type="text/javascript"></script>
        <script src="{{ asset('css/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}" type="text/javascript">
...
<script type="text/javascript">
 ...
 <script src="{{ asset('css/assets/pages/scripts/components-select2.min.js')}}" type="text/javascript"></script>
         <script src="{{ asset('css/assets/pages/scripts/table-datatables-buttons.min.js')}}" type="text/javascript"></script>
         <script src="{{asset('css/assets/pages/scripts/ui-buttons-spinners.min.js')}}" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="{{ asset('css/assets/layouts/layout4/scripts/layout.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('css/assets/layouts/layout4/scripts/demo.min.js') }}" type="text/javascript"></script>
