...
<a class="btn btn-success" href="{{route('document.create')}}"><i class="fa fa-plus"></i>Add CV</a>
                    ...
                    <p></p>
                    <p></p>
                       <span class="note note-primary" style="border: solid 1px #CCCCCC;">Filter shortlisted CV's by clicking on any of the colours available </span>
                    <p></p>
                    <p></p>
                    <br>
                        ...
                        <table width="10%" align="center" cellpadding="5" cellspacing="10">
                        <tr>
