...
<!--         <link rel="shortcut icon" href="favicon.ico" /> -->
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
        ...
        @include('admin.policies.layout.includes.sidenav')
            ...
            <ul>
                  <li >
                    <a href="{{ route('test.dashborad') }}"  class="active">
                        <span>@lang('cvmanagement.test.title')</span>
                        <i class="icon-arrow-up"></i>
                    </a>
                </li>
                <li>
...
$('#example').DataTable();
  ...
  <script src="{{ asset('css/assets/pages/scripts/components-editors.min.js')}}" type="text/javascript"></script>
...
<script type="text/javascript">
 ...
 $('#add_policy_markdown').click(function() { 
 alert("Text: " + $('textarea[name=summernote]').val());
        ...
        $.ajax({
            ...
            data:{
                ...
                'description':$('textarea[name=summernote]').val(), 
                'title':$('input[name=title]').val()
            },
            beforeSend: function(){
 
            $("#loader1").show();
            // $("#sec21").html('<p>Loding.......</p>');
            $("#m_show").show();
            },     
            success:function(data){
      
            $("#resulto").append('<i class="btn-success btn-xs"> Done </i>');
        // $('textarea[name=second_comment_description4]').focus();
            console.log(data);
 ...
 $('#update_policy_markdown').click(function() { 
 alert("Text: " + $('textarea[name=description]').val());
        ...
        $.ajax({
            ...
            data:{
                ...
                'title':$('input[name=title]').val(),
                'policy_id':$('input[name=policy_id]').val()
            },
            beforeSend: function(){
  ...
  $("#resulto").append('<i class="btn-success btn-xs">' + data.msg + ' </i>');
            // location.reload();
            },
