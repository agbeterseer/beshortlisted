...
@section('content')
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li class="divider"> </li>
                                                     ...
                                                     <li>
                                                        <a href="javascript:;"><i class="icon-docs"></i>Edit</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
     ...
     <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
                  <select name="country" class="form-control" required=""> 
                    ...
                    <option value="{{$contact->country}}">{{$country->name_en}} </option>
                    @endif
                        @endforeach
                    @foreach($countries as $country)
         ...
         <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
         <input id="state" type="text" class="form-control" name="state" value="{{$contact->state}}" required>
                    @if ($errors->has('state'))
                        <span class="help-block">
    ...
    <div class="form-group{{ $errors->has('street_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
         <input id="street_name" type="text" class="form-control" name="street_name" value="{{$contact->street_name}}" required>
         ...
         <div class="form-group{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
         <input id="postal_code" type="text" class="form-control" name="postal_code"  value="{{$contact->postalcode}}"  required>
         ...
         <div class="form-group{{ $errors->has('official_number') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8">
         <input id="official_number" type="text" class="form-control" name="official_number" value="{{$contact->phonenumber}}" required>
...
<div class="col-md-10">
<textarea name="description" id="summernote_1" class="form-control" required="required" >{{$contact->fulladdress}}</textarea>
