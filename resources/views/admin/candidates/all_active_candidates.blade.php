                ...
                <div class="modal-dialog modal-lg">
                  ...
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    <div class="fileinput-new thumbnail" style="width: 200px; height: 210px;">
                        <img src="{{ asset('uploads/avatars') }}/{{ $candidate->avatar }}"  alt="" width=" 300px" height="300px" />
                         </div> 
                       </div>
                      </div>
...
<div class="form-group">
     <label class="control-label"><strong> Full Name  :</strong>  </label> {{$candidate->name}} 
       ...
       @foreach($cities as $city)
              ...
              {{$candidate->city_id}} State

               </div> 
            </div> 
                  
        <div class="form-group">
        <label class="control-label"><strong> Contact Address: </strong></label> {{$candidate->contact_address}}
        </div>

        <div class="form-group">
        <label class="control-label"><strong> Phone Number:</strong></label> {{$candidate->phone_number}}</label>
