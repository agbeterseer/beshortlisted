        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('frequently.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('answer') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                              <textarea name="answer" class="form-control" placeholder="Enter answer" id="summernote_1"></textarea>
